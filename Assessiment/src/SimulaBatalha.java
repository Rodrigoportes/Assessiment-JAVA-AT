    ...
    public static void batalha(Personagem monstro, Personagem heroi, String nomeJogador) {
        ...
        while(true){
           contador++; 
            ...
            int sorteio2 = random.nextInt(10) + 1;
        ...
        if(iniciativaHeroi > iniciativaMonstro){
            ...
            System.out.println("O " + heroi.getNome() + " desfere um poderoso golpe!");
            atacante = heroi;
            defensor = monstro;
        ...
        if(ataque > defesa){
            ...
            if( defensor.getPontosDeVida() > 0){
                System.out.println("O " + defensor.getNome() + " sobrevive ao ataque e permanece com " + defensor.getPontosDeVida()+ " pontos de vida");
                System.out.println("------------------------------------------------");
                
            }else{
                System.out.println("A batalha acabou, VITÓRIA do  " + atacante.getNome());
                if (atacante.getNome().equals("Morto-Vivo") || atacante.getNome().equals("Orc") || atacante.getNome().equals("Kobold")){
                    result = "Perdeu";
                }else{
                    result = "Ganhou";
                }
                ...
                GravacaoLog registrar = new GravacaoLog(nomeJogador,dataAtual,heroi.getNome(),result,monstro.getNome(),contador);
